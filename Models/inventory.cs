...
namespace consolepirates.Models
{
    ...
    {
        public Orchid(int AmmountInStore, double storeSellMultiplier, double storeBuyMultiplier)
        {
            name = "Orchid";
    ...
    {
        public Sunflower(int AmmountInStore, double storeSellMultiplier, double storeBuyMultiplier)
        {
            name = "Sunflower";
    ...
    {
        public Coconut(int AmmountInStore, double storeSellMultiplier, double storeBuyMultiplier)
        {
            name = "Coconut";
    ...
    {
        public Papaya(int AmmountInStore, double storeSellMultiplier, double storeBuyMultiplier)
        {
            name = "Papaya";
    ...
    {
        public Cactus(int AmmountInStore, double storeSellMultiplier, double storeBuyMultiplier)
        {
